#!/usr/bin/env sh
# Universal installer for mevscope. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/mevscope.git"
echo "Installing mevscope ..."
